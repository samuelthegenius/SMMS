-- Role-Neutral Notification System
-- Updates handle_ticket_updates to use dynamic names and handle rejections
...
BEGIN
  ...
  ELSIF (TG_OP = 'UPDATE') THEN
    ...
    IF (NEW.rejection_reason IS DISTINCT FROM OLD.rejection_reason) AND (NEW.rejection_reason IS NOT NULL) AND (NEW.assigned_to IS NOT NULL) THEN
       INSERT INTO notifications (user_id, message, created_at)
